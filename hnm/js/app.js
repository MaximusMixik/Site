    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".swiper-services")) new swiper_core_Swiper(".swiper-services", {
                ...
                pagination: {
                    el: ".swiper-services .navigation__pagination",
                    type: "fraction",
                ...
                scrollbar: {
                    el: ".swiper-services .navigation__scrollbar",
                    draggable: true
                },
                navigation: {
                    prevEl: ".swiper-services .navigation__button--prev",
                    nextEl: ".swiper-services .navigation__button--next"
                },
                breakpoints: {
                    550: {
                        slidesPerView: 3.1
            ...
            function initTeamSwiper() {
                new swiper_core_Swiper(".swiper-team", {
                    modules: [ Navigation, Scrollbar, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.2,
                    ...
                    transitionTimingFunction: "ease-in-out",
                    pagination: {
                        el: ".swiper-team .navigation__pagination",
                        type: "fraction",
                        renderFraction: function(currentClass, totalClass) {
                            return '<span class="' + currentClass + '"></span>' + " / " + '<span class="' + totalClass + '"></span>';
                        }
                    ...
                    scrollbar: {
                        el: ".swiper-team .navigation__scrollbar",
                        draggable: true
                    },
                    navigation: {
                        prevEl: ".swiper-team .navigation__button--prev",
                        nextEl: ".swiper-team .navigation__button--next"
                    },
                    breakpoints: {
                        550: {
                            slidesPerView: 2.7
            ...
            if (document.querySelector(".team--grid .swiper-team") && window.innerWidth < 480) initTeamSwiper(); else if (document.querySelector(".team--slider .swiper-team")) initTeamSwiper();
            if (document.querySelector(".swiper-review")) new swiper_core_Swiper(".swiper-review", {
                modules: [ Navigation, Scrollbar, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.4,
                ...
                transitionTimingFunction: "ease-in-out",
                pagination: {
                    el: ".swiper-review .navigation__pagination",
                    type: "fraction",
                    renderFraction: function(currentClass, totalClass) {
                        return '<span class="' + currentClass + '"></span>' + " / " + '<span class="' + totalClass + '"></span>';
                    }
                ...
                scrollbar: {
                    el: ".swiper-review .navigation__scrollbar",
                    draggable: true
                },
                navigation: {
                    prevEl: ".swiper-review .navigation__button--prev",
                    nextEl: ".swiper-review .navigation__button--next"
                },
                breakpoints: {
                    550: {
                        slidesPerView: 3.1
...
***************************************************************************** */
        ...
        function borderRadiusFunction() {
            const galleryItems = document.querySelectorAll(".gallery__body a");
            ...
            const applyCorners = () => {
                ...
                const columns = window.innerWidth <= 991 ? 2 : 3;
                const rows = Math.ceil(totalItems / columns);
                const borderRadius = "10px";
                galleryItems.forEach(((item, index) => {
                    const currentRow = Math.floor(index / columns) + 1;
                    const currentCol = index % columns + 1;
                    if (index === 0) item.style.borderTopLeftRadius = borderRadius;
                    if (currentRow === 1 && currentCol === columns) item.style.borderTopRightRadius = borderRadius;
                    if (currentRow === rows && currentCol === 1) item.style.borderBottomLeftRadius = borderRadius;
                    if (currentRow === rows && currentCol === columns) item.style.borderBottomRightRadius = borderRadius;
                }));
            };
            applyCorners();
            let resizeTimeout;
