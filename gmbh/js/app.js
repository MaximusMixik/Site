 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-big")) new swiper_core_Swiper(".slider-big", {
                ...
                navigation: {
                    prevEl: ".slider-big__nawigation .slider-navigation__button_prev",
                    nextEl: ".slider-big__nawigation .slider-navigation__button_next"
                },
                thumbs: {
                    swiper: {
                        el: ".slider-small",
            ...
            if (document.querySelector(".swiper-template")) new swiper_core_Swiper(".swiper-template", {
                ...
                navigation: {
                    prevEl: ".swiper-template .slider-navigation__button_prev",
                    nextEl: ".swiper-template .slider-navigation__button_next"
                }
            });
            if (document.querySelector(".products-swiper")) new swiper_core_Swiper(".products-swiper", {
                ...
                navigation: {
                    prevEl: ".products__nawigation .slider-navigation__button_prev",
                    nextEl: ".products__nawigation .slider-navigation__button_next"
                }
            });
        }
...
***************************************************************************** */
        ...
        const scrollFunc = () => {
            ...
            if (y > 150) scrollToTopButton.className = "scroll-top show"; else scrollToTopButton.className = "scroll-top hide";
        };
        ...
        //! sub menu active
                const subMenuItem = document.querySelectorAll(".spollers-menu__link");
        const subMenuTitle = document.querySelector(".spollers-menu__title");
        ...
        //! logo active
                const logoItem = document.querySelector(".header__logo");
        if ("/" + logoItem.getAttribute("href") === window.location.pathname) logoItem.classList.add("active");
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
        menuInit();
