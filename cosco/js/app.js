(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-hero")) new swiper_core_Swiper(".swiper-hero", {
    ...
    function mouseAction(e) {
        const targetElement = e.target;
        if (targetElement.classList.contains("column-about")) {
            const allColumns = document.querySelectorAll(".column-about");
            script_removeClasses(allColumns);
            targetElement.classList.add("column-about--active");
        }
    }
