 ...
 */            (function(window, factory) {
    ...
    (() => {
                ...
                if (sortButtons.length) sortButtons.forEach((button => {
                    button.addEventListener("click", (() => {
                        ...
                        if (!isActive) {
                            ...
                            filterCaption.innerHTML = `Sort by <span>${label}</span>`;
        ...
        function initSliders() {
            if (document.querySelector(".popular__swiper")) new swiper_core_Swiper(".popular__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                grabCursor: true,
            ...
            if (document.querySelector(".tag__swiper")) new swiper_core_Swiper(".tag__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                freeMode: true,
            ...
            if (dropdownElements.length) {
                dropdownElements.forEach((el => {
                    el.addEventListener("click", (event => {
                        ...
                        } else el.classList.add("dropdown-open");
                    }));
                }));
        ...
        //! open filters
            ...
            const closeButton = document.querySelectorAll(".filters__close , .filters__button");
            if (filterButton && closeButton) {
        ...
        function copyLink() {
            const body = document.querySelector(".copy-link");
            const successButton = document.querySelector(".copy-link__success");
            if (body && successButton) {
                const copyLinkButtons = document.querySelectorAll(".copy-link__button");
                copyLinkButtons.forEach((button => {
                    button.addEventListener("click", (() => {
                        const link = button.parentElement.querySelector(".copy-link__address");
        ...
        function applySavedTheme() {
            ...
            if (savedTheme === "dark") darkTheme(); else lightTheme();
        }
        function toggleTheme() {
            const currentTheme = localStorage.getItem("color-theme");
            if (currentTheme === "light") darkTheme(); else lightTheme();
        }
        function colorTheme() {
            applySavedTheme();
        }
        function compressImage(file, callback) {
            ...
            reader.onload = function(event) {
                ...
                img.onload = function() {
                    ...
                    const compressedDataUrl = canvas.toDataURL("image/jpeg", .7);
                    callback(compressedDataUrl);
                };
            };
        }
        function initAvatarUpload() {
            const avatarImage = document.querySelector(".avatar-settings__img img");
            const avatarInput = document.querySelector(".avatar-settings__row input ");
            const chooseAvatarButton = document.querySelector(".avatar-settings__button");
            if (avatarImage && avatarInput && chooseAvatarButton) {
                ...
                avatarInput.addEventListener("change", (function() {
                    ...
                    if (file) compressImage(file, (function(compressedDataUrl) {
                        avatarImage.src = compressedDataUrl;
        ...
        function togglePassword() {
            ...
            const button = document.querySelector(".login-form__show-password");
            if (!button) return;
            button.addEventListener("click", (e => {
                e.preventDefault();
