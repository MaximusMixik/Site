(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-pricing")) new swiper_core_Swiper(".swiper-pricing", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-pricing .navigation__button--prev",
                nextEl: ".swiper-pricing .navigation__button--next"
            },
            on: {}
        });
    }
